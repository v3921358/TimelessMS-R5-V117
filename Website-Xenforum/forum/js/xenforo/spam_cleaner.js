...
function(){d(this).data("XenForo.OverlayTrigger").deCache()})})}):a._redirectTarget?e.location=a._redirectTarget:c.data("overlay").close()})})};XenForo.register(".SpamCleaner","XenForo.SpamCleaner")})(jQuery,this,document);
