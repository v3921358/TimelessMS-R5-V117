...
function action(mode, type, selection) {
    ...
    return;
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            var text = "#b어메이징 미라클 큐브 조각 #r#c2430759#개#k를 가지고 있습니다. 금빛 각인의 인장은 #r5개#k, 고급 장비강화 주문서는 #r10개#k, 에픽 잠재능력 주문서 80%는 #r20개#k를 사용하여 교환할 수 있습니다.\r\n\r\n";
                text += "#b#L0##i2049500# #z2049500##l\r\n";
		text += "#b#L1##i2049300# #z2049300##l\r\n";
		text += "#b#L2##i2049701# #z2049701##l";
            cm.sendSimple(text);
        } else if(status == 1) {
            if (selection == 0) {
                if (cm.haveItem(2430759, 5)) {
