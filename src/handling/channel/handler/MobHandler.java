...
/* 166 */       FileoutputUtil.outputFileError("MovementLog.txt", e);
/* 167 */       FileoutputUtil.log("MovementLog.txt", "MOBID " + monster.getId() + ", AIOBE Type2:\n" + slea.toString(true));
/* 168 */       return;
     }
...
/* 182 */       if (slea.available() != 36L)
       {
/* 185 */         FileoutputUtil.log("PacketLog.txt", "slea.available != 35 (movement parsing error)\n" + slea.toString(true));
