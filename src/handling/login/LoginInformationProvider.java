...
public class LoginInformationProvider {
    ...
    public enum JobType {
        ...
        UltimateAdventurer(-1, "Ultimate", 0, 180000001),
        Resistance(0, "Resistance", 3000, 180000001),
        Adventurer(1, "", 0, 180000001),
        Cygnus(2, "Premium", 1000, 180000001),
        Aran(3, "Orient", 2000, 180000001),
        Evan(4, "Evan", 2001, 180000001),
        Mercedes(5, "", 2002, 180000001),
        Demon(6, "", 3001, 180000001),
        Phantom(7, "", 2003, 180000001),
        DualBlade(8, "", 0, 180000001),
        Mihile(9, "", 0, 180000001),
        Jett(10, "", 0, 180000001);
